...
import { DeletePageHandler } from "./delete.handler";
...
describe("DeletePageHandler", () => {
  ...
  beforeEach(() => {
    ...
    handler = new DeletePageHandler(mockRepo as unknown as IPagesRepository);
  });

  it("should delete the existing page and return success", async () => {
